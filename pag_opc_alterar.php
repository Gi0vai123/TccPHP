            ...
            <div class="resultado">
                <?php
                      ...
                      $slq_query_codigo = $conexao->query($sql_code_codigo) or die($conexao->error);
                            ...
                            echo " <th>Codigo</th> <th>Nome</th> <th>idade</th> <th>Turmas</th> <th>Ensino</th> <th>Status</th>  <th>Alterar</th> "; 
                              ...
                              while($row = mysqli_fetch_array($slq_query_todos, MYSQLI_ASSOC))
                              {
                                  ...
                                  echo "</td>";
                                  echo "<td><a href='alterar.php?codigo=$row[codigo]&nome=$row[nome]&idade=$row[idade]&turma=$row[classe_n]&ensino=$row[ensino_n]&stat=$row[stts]'>Alterar</a> </td>"; 
                                  echo "</tr>";
                              }
                                echo "</table>";
